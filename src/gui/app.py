...
class CompilerGUI(tk.Tk):
    ...
    def analizar_codigo(self):
        ...
        try:
            ...
            error_text = str(e)
            display_text = "joda rosa vas a seguir?" if self.last_error == error_text else error_text
            self.last_error = error_text
            self.lbl_error.config(text=display_text, fg=self.error_color)
            messagebox.showerror("Error Léxico", display_text)
            ...
            self.last_error = error_text
            self.lbl_error.config(text=display_text, fg=self.error_color)
            messagebox.showerror("Error Sintáctico", display_text)
            ...
            self.last_error = error_text
            self.lbl_error.config(text=display_text, fg=self.error_color)
            messagebox.showerror("Error Semántico", display_text)
